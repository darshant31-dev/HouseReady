...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#fcfbf8] text-[#1c1f22] font-sans selection:bg-teal-500/20" ref={ref}>
            ...
            "@graph": [
              {
                ...
                "description": "An end-to-end managed home-readiness platform for Indian renters and owners.",
                "address": {
                  "@type": "PostalAddress",
              ...
              },
              {
                ...
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "What exactly is HouseReady?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "We are an end-to-end managed home readiness platform. Instead of hiring a cleaner, painter, and plumber separately, you buy an outcome (e.g., Make my house Move-In Ready) and we coordinate our verified partners to deliver it."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Do you provide the services yourselves?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "We coordinate a trusted network of verified local service partners. You only ever deal with us—we handle the scheduling, quality checks, and payments."
                    }
                  }
                ]
              }
      ...
      {/* FLOATING WHATSAPP */}
      <Link href="https://wa.me/919000000000?text=Hi%20HouseReady,%20I%20need%20help%20getting%20my%20house%20ready." target="_blank" aria-label="Chat with us on WhatsApp" className="fixed bottom-24 right-4 md:bottom-8 md:right-8 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:scale-110 transition-transform">
